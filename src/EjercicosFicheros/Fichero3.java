package EjercicosFicheros;//Una ruta con URI, crear el objeto, verificar que existe(else if), si es un pruebauri o un archivo(else if)(try catch)
        ...
        try{
            ...
            if(pruebaURI.exists()) {
                if (pruebaURI.isDirectory()) {
                    ...
                    System.out.println("La ruta presenta un directorio en " + pruebaURI.toString());
                    ...
                    System.out.println("La ruta presenta un archivo en " + pruebaURI.toString());
                }
            }else{
